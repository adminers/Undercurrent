...
import com.keta.generate.db.Column;
import com.keta.generate.db.Table;
...
public class ConvertHandler
{
        ...
        throws SQLException
    {
        ...
        {
            throw new SQLException(ConvertHandler.class.getName() + ": 参数  Table 不能为null.");
        }
        if (table.getColumns() == null || table.getColumns().isEmpty())
        {
            throw new SQLException(ConvertHandler.class.getName() + ":  表：[ " + table.getTableName() + " ] ,不包含任何列信息...");
        }
        /************** 数据库类型转JAVA类型 *******************/
        for (Column col : table.getColumns())
        {
            ...
            {
                throw new SQLException(ConvertHandler.class.getName() + ": 转换column为field时出错,column:[" + col.getName() + "].");
            }
        }
        /************** 验证主键 *******************/
        cleanColumn(table);
