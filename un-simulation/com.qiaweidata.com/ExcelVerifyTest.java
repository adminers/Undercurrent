 ...
 * Excel 导入校验
 * 
 * @author JueYue 2015年10月31日 下午10:34:35
 */
public class ExcelVerifyTest
{
    ...
    public void basetest()
    {
        try
        {
            ...
            ExcelImportResult<ExcelVerifyEntity> result = ExcelImportUtil.importExcelMore(new File(FileUtilTest.getWebRootPath("import/verfiy.xlsx")), ExcelVerifyEntity.class, params);
    ...
    public void baseModetest()
    {
        try
        {
            ImportParams params = new ImportParams();
            params.setNeedVerify(true);
            ExcelImportResult<ExcelVerifyEntityOfMode> result = ExcelImportUtil.importExcelMore(new FileInputStream(new File(FileUtilTest.getWebRootPath("import/verfiy.xlsx"))), ExcelVerifyEntityOfMode.class, params);
    ...
    public void baseHandlertest()
    {
        try
        {
            ...
            ExcelImportResult<ExcelVerifyEntityOfMode> result = ExcelImportUtil.importExcelMore(new File(FileUtilTest.getWebRootPath("import/verfiy.xlsx")), ExcelVerifyEntityOfMode.class, params);
