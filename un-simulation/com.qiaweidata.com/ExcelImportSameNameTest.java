 ...
 * 同名列导入测试
 * 
 * @author JueYue 2015年5月2日 上午11:19:40
 */
public class ExcelImportSameNameTest
{
    ...
    public void exportTest()
    {
        ...
        studentEntity.setRegistrationDate(new java.sql.Time(System.currentTimeMillis()));
    ...
    public void importTest()
    {
        ...
        List<ClassName> list = ExcelImportUtil.importExcel(new File(FileUtilTest.getWebRootPath("import/sameName.xls")), ClassName.class, params);
