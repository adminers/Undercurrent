...
/**
 * A message that represents a drawing action. Note that we use primitive types instead of Point, Color etc. to reduce object allocation.<br>
 * <br>
 *
 * TODO: But a Color objects needs to be created anyway for drawing this onto a Graphics2D object, so this probably does not save much.
 */
public final class DrawMessage
{
    ...
    public DrawMessage(int type, byte colorR, byte colorG, byte colorB, byte colorA, double thickness, double x1, double x2, double y1, double y2)
    {
    ...
    public String toString()
    {
        ...
        return type + "," + (colorR & 0xFF) + "," + (colorG & 0xFF) + "," + (colorB & 0xFF) + "," + (colorA & 0xFF) + "," + thickness + "," + x1 + "," + y1 + "," + x2 + "," + y2;
    }
        ...
        throws ParseException
    {
        ...
        DrawMessage m = new DrawMessage(type, colors[0], colors[1], colors[2], colors[3], thickness, coords[0], coords[2], coords[1], coords[3]);
