...
/**
 * Oralce Metadata读取 2018-11-14
 */
public class Oracle extends MyDataSource
{
    @Override
        ...
        throws SQLException
    {
        ...
        try (Connection connection = getConnection())
        {
            ...
            ps = connection.prepareStatement("select table_name from user_tables order by table_name");
            rs = ps.executeQuery();
