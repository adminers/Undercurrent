package cn.afterturn.easypoi.tohtml;
...
public class WpsToHtmlController
{
     ...
     */
    @RequestMapping("03")
    public String toHtmlOf03Base(HttpServletResponse response)
     ...
     */
    @RequestMapping("07")
    public String toHtmlOf07Base(HttpServletResponse response)
        throws IOException, InvalidFormatException
    {
    ...
    public String toHtmlOf03Img(HttpServletResponse response)
        throws IOException, InvalidFormatException
    {
    ...
    public String toHtmlOf07Img(HttpServletResponse response)
        throws IOException, InvalidFormatException
    {
